            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        ...
                        _context2.t0 = ext;
                        _context2.next = _context2.t0 === ".mov" ? 7 : _context2.t0 === ".mp4" ? 7 : 29;
                        break;
                    ...
                    case 15:
                        _context2.next = 17;
                        return fs.mkdir(_path + "/append");

                    case 17:
                        _context2.next = 19;
                        return upload_video.mv(_path + '/original' + ext);

                    case 19:
                        _context2.next = 21;
                        return new ffmpeg(_path + '/original' + ext).screenshots({
                            timestamps: ['50%'],
                    ...
                    case 21:
                        _context2.next = 23;
                        return ffmpeg.ffprobe(_path + '/original' + ext, function (err, metadata) {
                            if (err) {
                                console.error(err);
                            } else {
